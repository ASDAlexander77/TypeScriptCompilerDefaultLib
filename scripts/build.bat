...
set ROOT=..\..
set GC_LIB_PATH=%ROOT%\TypeScriptCompiler\__build\gc\msbuild\x64\%BUILD%\Debug
set LLVM_LIB_PATH=%ROOT%\TypeScriptCompiler\__build\llvm\msbuild\x64\%BUILD%\Debug\lib
...
%ROOT%\TypeScriptCompiler\3rdParty\llvm\x64\%LLVM_BUILD%\bin\llvm-lib.exe %OUTPUT%\lib\lib.obj
