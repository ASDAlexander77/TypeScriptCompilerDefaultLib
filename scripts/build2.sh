...
# Build DLL
gcc -shared $DBG_GCC $OUTPUT/lib/$BUILD/lib.o $OUTPUT/lib/$BUILD/lib.linux.o $OUTPUT/lib/$BUILD/datetime.o $OUTPUT/lib/$BUILD/regex.o -o $OUTPUT/dll/$BUILD/libTypeScriptDefaultLib.so
