...
%TOOL_PATH%\tslang.exe  --nowarn --shared-libs=%TOOL_PATH%\TypeScriptRuntime.dll --default-lib-path=__build --gc-lib-path=%GC_LIB_PATH% --tslang-lib-path=%TSLANG_LIB_PATH% --llvm-lib-path=%LLVM_LIB_PATH% --emit=exe %1