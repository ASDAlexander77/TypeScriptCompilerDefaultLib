...
%TOOL_PATH%\tsc.exe  --nowarn --shared-libs=%TOOL_PATH%\TypeScriptRuntime.dll --default-lib-path=__build\release --gc-lib-path=%GC_LIB_PATH% --tsc-lib-path=%TSC_LIB_PATH% --llvm-lib-path=%LLVM_LIB_PATH% --emit=exe %1